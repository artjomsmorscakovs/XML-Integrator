<?php
/**
 * An OpenSource Autoloader class
 * 
...
class Autoloader {
	...
	protected static $classFileSuffix = '.php';//AM: 13.02.12 updated defaults'.class.php';
	...
	public static function saveCachedPaths() {
		// AM 13.02.12 if no file is specified do not trigger error. 
		// raise exception only if file is not writeable
		if (!is_null(self::$cacheFilePath)){
